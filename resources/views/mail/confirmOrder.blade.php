...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Merriweather:wght@100;200;300;400;500;600;700;800;900"
    ...
    <style>
        * {
        ...
        @media (max-width: 690px) {
            ...
            .row-4 .column-3 .block-5.social_block .alignment table,
            ...
            .row-4 .column-2 .block-2.divider_block td.pad,
            .row-4 .column-3 .block-2.divider_block td.pad {
                padding: 0 10px !important;
            }

            .row-4 .column-2 .block-2.divider_block .alignment table,
            .row-4 .column-3 .block-2.divider_block .alignment table {
            ...
            .row-4 .column-3 .block-3.paragraph_block td.pad > div,
            .row-4 .column-3 .block-4.paragraph_block td.pad > div {
                font-size: 14px !important;
            }

            .row-4 .column-3 .block-5.social_block td.pad {
                padding: 20px !important;
            }

            .row-4 .column-3 .block-5.social_block .alignment {
...
<table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation"
       style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #37474f;">
    <tbody>
    <tr>
        <td>
                ...
                <tr>
                    <td>
                        <table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0"
                               role="presentation"
                               style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #e6f9f7; color: #000000; width: 670px; margin: 0 auto;"
                               width="670">
                            <tbody>
                            <tr>
                                <td class="column column-1" width="16.666666666666668%"
                                    ...
                                    <table class="image_block block-1" width="100%" border="0" cellpadding="15"
                                           cellspacing="0" role="presentation"
                                           style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                        <tr>
                                            <td class="pad">
                                                <div class="alignment" align="center" style="line-height:10px">
                                                    <div style="max-width: 81.667px;"><a href="www.example.com"
                                                                                         target="_blank"
                                                                                         style="outline:none"
                                                                                         tabindex="-1"><img
                                                                src="https://90a1257530.imgdist.com/pub/bfra/eoyahag8/hhd/alo/15c/logo.jpg"
                                                                style="display: block; height: auto; border: 0; width: 100%; border-radius: 200px;"
                                                                width="81.667" alt="company logo" title="company logo"
                                                                height="auto"></a></div>
                                                </div>
                                            </td>
                                        </tr>
                                ...
                                <td class="column column-2" width="83.33333333333333%"
                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; padding-top: 5px; vertical-align: middle; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
                                        ...
                                        <tr>
                                            <td class="pad">
                                                <h1 style="margin: 0; color: #2a615b; direction: ltr; font-family: 'Merriweather', 'Georgia', serif; font-size: 38px; font-weight: 400; letter-spacing: normal; line-height: 150%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 57px;">
                                                    <span class="tinyMce-placeholder" style="word-break: break-word;">Orden Confirmada</span>
                                                </h1>
                                            </td>
                                        </tr>
                                    </table>
                        ...
                        <table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td class="column column-1" width="100%"
                                    ...
                                    <table class="button_block block-2" width="100%" border="0" cellpadding="10"
                                           cellspacing="0" role="presentation"
                                           style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                        <tr>
                                            <td class="pad">
                                                <div class="alignment" align="center"><!--[if mso]>
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                 xmlns:w="urn:schemas-microsoft-com:office:word"
                                                                 style="height:42px;width:242px;v-text-anchor:middle;"
                                                                 arcsize="58%" stroke="false" fillcolor="#2a615b">
                                                        <w:anchorlock/>
                                                        <v:textbox inset="0px,0px,0px,0px">
                                                            <center dir="false"
                                                                    style="color:#d6f8f2;font-family:Arial, sans-serif;font-size:16px">
                                                    <![endif]--><p
                                                        style="background-color:#2a615b;border-bottom:0px solid transparent;border-left:0px solid transparent;border-radius:24px;border-right:0px solid transparent;border-top:0px solid transparent;color:#d6f8f2;display:inline-block;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:undefined;mso-border-alt:none;padding-bottom:5px;padding-top:5px;text-align:center;text-decoration:none;width:auto;word-break:keep-all;"><span
                                                            style="word-break: break-word; padding-left: 15px; padding-right: 15px; font-size: 16px; display: inline-block; letter-spacing: 1px;"><span
                                                                style="word-break: break-word; line-height: 32px;"><strong>ORDEN N° {{$order->number}}</strong></span></span>
                                                    </p>
                                                    <!--[if mso]></center></v:textbox></v:roundrect><![endif]--></div>
                                            </td>
                                        </tr>
                                    ...
                                    <table class="table_block block-5" width="100%" border="0" cellpadding="10"
                                           cellspacing="0" role="presentation"
                                           style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                        <tr>
                                            <td class="pad">
                                                <table
                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; width: 100%; table-layout: fixed; direction: ltr; background-color: transparent; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-weight: 400; color: #101112; text-align: left; letter-spacing: 0px; word-break: break-all;"
                                                    width="100%">
                                                    <tbody
                                                        style="vertical-align: top; font-size: 16px; line-height: 120%;">
                                                    <tr>
                                                        <td width="100%"
                                                            colspan="3"
                                                            style="font-size:14px;font-weight: bold;padding: 10px; word-break: break-word;">
                                                            Detalle del Pedido
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="60%"
                                                            colspan="2"
                                                            style="font-size:14px;text-align: left; padding: 10px; word-break: break-word;">
                                                            {{$order->sendInformation->method === 'delivery'? $order->deliveryDate: $order->shippingDate}}
                                                        </td>
                                                    </tr>
                                                    @foreach($order->orderItems as $item)
                                                        <tr>
                                                            <td width="30%"
                                                                style="text-align: center; padding: 10px; word-break: break-word;">
                                                                <img width="40px"
                                                                     src="{{$item->productDetail->product->image->url}}"
                                                                     alt="product">
                                                            </td>
                                                            <td
                                                                width="40%"
                                                                style="vertical-align: center; padding: 10px; word-break: break-word;">
                                                                <p style="margin: 0; font-weight: bold;">{{$item->productDetail->product->name}}</span>
                                                                <p style="opacity: 90;margin: 0;">{{$item->productDetail->color->name}}</span>
                                                                <p style="opacity: 80;margin: 0">{{$item->productDetail->size->name}}</span>
                                                            </td>
                                                            <td width="30%"
                                                                style="padding: 10px; word-break: break-word; text-align: center">
                                                                {{(int)$item->quantity}}
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                    ...
                                    <table class="paragraph_block block-7" width="100%" border="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td class="pad"
                                                style="padding-bottom:35px;padding-left:40px;padding-right:40px;padding-top:10px;">
                                                <div
                                                    style="color:#393d47;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:12px;font-weight:400;line-height:120%;text-align:center;mso-line-height-alt:14.399999999999999px;">
                                                    <p style="margin: 0; word-break: break-word;">Si tienes alguna duda
                                                        o necesitas más información, no dudes en contactarnos
            ...
            <table class="row row-4" align="center" width="100%" border="0" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td>
                        <table class="row-content stack" align="center" border="0" cellpadding="0" cellspacing="0"
                               role="presentation"
                               style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #2a615b; color: #000000; width: 670px; margin: 0 auto;"
                               width="670">
                            <tbody>
                            <tr>
                                <td class="column column-1" width="33.333333333333336%"
                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; padding-top: 5px; vertical-align: middle; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
                                    <table class="image_block block-1" width="100%" border="0" cellpadding="40"
                                           cellspacing="0" role="presentation"
                                           style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                        <tr>
                                            <td class="pad">
                                                <div class="alignment" align="left" style="line-height:10px">
                                                    <div style="max-width: 122.833px;"><a href="www.example.com"
                                                                                          target="_blank"
                                                                                          style="outline:none"
                                                                                          tabindex="-1"><img
                                                                src="https://90a1257530.imgdist.com/pub/bfra/eoyahag8/hhd/alo/15c/logo.jpg"
                                                                style="display: block; height: auto; border: 0; width: 100%; border-radius: 200px;"
                                                                width="122.833" alt="company logo" title="company logo"
                                                                height="auto"></a></div>
                                                </div>
                                            </td>
                                        </tr>
                                ...
                                <td class="column column-2" width="33.333333333333336%"
                                    ...
                                    <table class="heading_block block-1" width="100%" border="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-left:20px;text-align:center;width:100%;">
                                                <h3 style="margin: 0; color: #ffffff; direction: ltr; font-family: Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 200%; text-align: left; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 32px;">
                                                    <strong>Nosotros</strong></h3>
                                            </td>
                                        </tr>
                                    </table>
                                    <table class="divider_block block-2" width="100%" border="0" cellpadding="10"
                                           cellspacing="0" role="presentation"
                                           style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                        <tr>
                                            <td class="pad">
                                    ...
                                    <table class="paragraph_block block-3" width="100%" border="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td class="pad"
                                                style="padding-bottom:25px;padding-left:20px;padding-right:20px;padding-top:5px;">
                                                <div
                                                    ...
                                                    <p style="margin: 0; word-break: break-word;"><span
                                                            style="word-break: break-word;">Somos un empresa enfocada en hacerlas sentir cómodas y hermosas. Ofrecemos prendas femeninas en tendencia.</span><span
                                            ...
                                            <td class="pad"
                                                ...
                                                <div
                                                    ...
                                                    <p style="margin: 0; word-break: break-word;"><a
                                                            ...
                                                            rel="noopener">lesleslie.vas.eco@gmail.com</a></p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                            ...
                                            <td class="pad"
                                                ...
                                                <div
                                                    ...
                                                    <p style="margin: 0; word-break: break-word;"><a
                                                            href="http://www.example.com" target="_blank"
                                                            style="text-decoration: none; color: #e9e7e7;"
                                                            rel="noopener">914 173 535</a></p>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                    <table class="social_block block-5" width="100%" border="0" cellpadding="0"
                                           cellspacing="0" role="presentation"
                                           style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                        <tr>
                                            <td class="pad"
                                                ...
                                                <div class="alignment" align="left">
                                                    <table class="social-table" width="156px" border="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding:0 20px 0 0;"><a
                                                                    href="https://www.whatsapp.com" target="_blank"><img
                                                                        src="https://app-rsrc.getbee.io/public/resources/social-networks-icon-sets/circle-gray/whatsapp@2x.png"
                                                                        width="32" height="auto" alt="WhatsApp"
                                                                        title="WhatsApp"
                                                                        style="display: block; height: auto; border: 0;"></a>
                                                            </td>
                                                        </tr>
